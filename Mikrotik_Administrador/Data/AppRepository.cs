...
namespace Mikrotik_Administrador.Data
{
    public class AppRepository : IDisposable
    {
        ...
        public async Task<List<ListHistorialMovimientosModel>> GetHistorialMovimientos(DateTime Desde, DateTime Hasta)
        {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetHistorialMovimientos", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public async Task<int> SaveComment(int Id, string Nombre, int IdMikrotik)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("SaveComment", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@Id", Id));
                        cmd.Parameters.Add(new SqlParameter("@Nombre", Nombre));
        ...
        public async Task<List<ListPlanesModel>> GetPlanesbyName(string Nombre, bool? IsAntena, bool PorUsuarios)
        {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetPlanesbyName", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@Nombre", Nombre));
                        cmd.Parameters.Add(new SqlParameter("@IsAntena", IsAntena));
                        ...
                        using (var reader = await cmd.ExecuteReaderAsync().ConfigureAwait(false))
                        {
                            while (await reader.ReadAsync().ConfigureAwait(false))
                            {
                                list.Add(MapToListPlanes(reader));
                            }
                        }
                    }
                }
        ...
        private ListPlanesModel MapToListPlanes(SqlDataReader reader)
        {
            return new ListPlanesModel()
            {
                Id = (int)reader["Id"],
                Nombre = (string)reader["Nombre"],
                Precio = (decimal)reader["Precio"],
        ...
        public async Task<PlanModel> GetPlanByIdUsuarioM(int IdUsuarioM)
        {
            PlanModel response = new PlanModel();
            List<PlanModel> list = new List<PlanModel>();
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetPlanByIdUsuarioM", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@IdUsuarioM", IdUsuarioM));
                        await sql.OpenAsync().ConfigureAwait(false);
        ...
        public async Task<PlanAnidadoModel> GetPlanesAnidadosbyParametros(int IdMikrotik, int IdPlan)
        {
        ...
        public async Task<MikrotikModel> GetMikrotikbyIPFibra(string IP)
        {
            MikrotikModel response = new MikrotikModel();
            List<MikrotikModel> list = new List<MikrotikModel>();
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetMikrotikbyIPFibra", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@IP", IP));
                        await sql.OpenAsync().ConfigureAwait(false);
        ...
        public async Task<MikrotikModel> GetMikrotikbyIPAntena(string IP)
        {
            MikrotikModel response = new MikrotikModel();
            List<MikrotikModel> list = new List<MikrotikModel>();
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetMikrotikbyIPAntena", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@IP", IP));
                        await sql.OpenAsync().ConfigureAwait(false);
        ...
        public async Task<List<ListMikrotikModel>> GetMikrotiksByIdPlan(int IdPlan)
        {
            ...
            try
            {
                using (SqlConnection sql = new SqlConnection(MikrotikConnection))
                {
                    using (SqlCommand cmd = new SqlCommand("GetMikrotiksByIdPlan", sql))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add(new SqlParameter("@IdPlan", IdPlan));
                        await sql.OpenAsync().ConfigureAwait(false);
